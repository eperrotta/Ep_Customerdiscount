<?php
class Ep_Customerdiscount_Block_Adminhtml_Customerdiscount_Edit_Tab_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _prepareCollection()
	{
		...
		Mage::getResourceModel('customerdiscount/customergrid')->addGridPosition($collection,$tm_id);
...
*/
	...
	{
		return $this->_getData('grid_url') ? $this->_getData('grid_url') : $this->getUrl('*/*/customergridlist', array('_current'=>true));
	}
	public function getSelectedCustomers()
	{
		...
		$collection->addFieldToFilter('discount_id',$tm_id);
		$custIds = array();
